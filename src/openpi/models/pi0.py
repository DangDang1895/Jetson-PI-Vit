...
class Pi0(_model.BaseModel):
    ...
    @at.typecheck
    def embed_prefix_from_visual_tokens(
        self,
        observation: _model.Observation,
        visual_tokens: at.Float[at.Array, "b v d"],
        visual_mask: at.Bool[at.Array, "b v"],
    ) -> tuple[
        at.Float[at.Array, "b s emb"],
        at.Bool[at.Array, "b s"],
        at.Bool[at.Array, " s"],
    ]:
        """使用共享 SigLIP 输出继续构造大脑 prefix。"""
    ...
    @at.typecheck
    def prefix_hidden_states_and_kv_from_visual(
        self,
        observation: _model.Observation,
        visual_tokens: at.Float[at.Array, "b v d"],
        visual_mask: at.Bool[at.Array, "b v"],
        ...
        """从共享视觉 tokens 继续计算 H 和 KV cache。"""
        ...
        prefix_tokens, prefix_mask, prefix_ar_mask = (
            self.embed_prefix_from_visual_tokens(
                observation,
                visual_tokens,
                visual_mask,
            )
    ...
    def sample_actions_from_cached_kv(
        ...
        observation: _model.Observation,
        *,
        cached_kv_cache: _gemma.KVCache,
        cached_prefix_mask: at.Bool[
            at.Array,
            "b p",
        ],
        num_steps: int | at.Int[at.Array, ""] = 10,
        future_condition_tokens: at.Float[
            at.Array,
            "b m d",
        ] | None = None,
        noise: at.Float[
        ...
        def step(carry):
            ...
            assert full_attn_mask.shape == (
                batch_size,
                suffix_tokens.shape[1],
                prefix_length + suffix_tokens.shape[1],
            )
